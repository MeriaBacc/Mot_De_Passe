...
function afficher()
{
        ...
        var divContenu1 = document.getElementById("myTable1");

        if(divContenu.style.display == 'none' || divContenu1.style.display == 'block') {
...
function afficher1()
{
        ...
        if(divContenu1.style.display == 'none' || divContenu.style.display == 'block') {
            divContenu.style.display = 'none';
...
function affiche1(valeur){
    document.getElementById("outputy").value += valeur ;
}
...
function test(){
    ...
    var ch2 = document.getElementById("outputy").value;
